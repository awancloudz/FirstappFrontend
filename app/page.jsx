...
import Newrelease from './movies/newrelease';
  ...
  return(
        ...
        <div class="container">
          <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6">
                <h4 class="gen-heading-title">New Release</h4>
              </div>
    ...
    <section class="pt-0 gen-section-padding-2">
        <div class="container">
          <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6">
                <h4 class="gen-heading-title">Category #1</h4>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-inline-block">
                <div class="gen-movie-action">
                    <div class="gen-btn-container text-right">
    ...
    <section class="pt-0 gen-section-padding-2">
        <div class="container">
          <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6">
                <h4 class="gen-heading-title">Category #2</h4>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-inline-block">
                <div class="gen-movie-action">
                    <div class="gen-btn-container text-right">
